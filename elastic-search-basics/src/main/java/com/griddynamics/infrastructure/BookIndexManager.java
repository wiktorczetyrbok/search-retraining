package com.griddynamics.infrastructure;
...
public class BookIndexManager {
    ...
    public BookIndexManager(RestHighLevelClient esClient) {
    ...
    public String createTimestampedIndex(String baseAlias, String settings, String mappings) {
        ...
        org.elasticsearch.client.indices.CreateIndexRequest request = new CreateIndexRequest(newIndexName)
